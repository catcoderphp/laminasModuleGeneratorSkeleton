 ...
 */
class BaseMapper extends Mapper implements MapperInterface
{
    /**
     ...
     */
    public function __construct(ResponseHandlerService $responseHandlerService, BaseService $baseService)
    {
